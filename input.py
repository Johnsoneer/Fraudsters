...
def to_database(json_file,risk_level,probability):
    '''
    ...
    df['fraud_probability'] = probability
    engine = create_engine('postgresql://William:tiger@209.249.11.227:5432/fraudsters')
